...
```mermaid
flowchart TD
    START["Hangi modu\nkullanmalıyım?"] --> Q1{"Dosya değişikliği\nyapılacak mı?"}

    Q1 -->|"Hayır"| PLAN["✅ plan modu\nSadece analiz"]

    Q1 -->|"Evet"| Q2{"Kullanıcı etkileşimi\nolacak mı?"}

    Q2 -->|"Hayır\n(otomasyon)"| Q3{"Ortam izole mi?\n(container/CI)"}

    Q3 -->|"Evet"| BYPASS["⚠️ bypassPermissions\n+ sandbox"]
    Q3 -->|"Hayır"| DONTASK["🔒 dontAsk\n+ allow listesi"]

    Q2 -->|"Evet\n(etkileşimli)"| Q4{"Çok sayıda dosya\ndeğişikliği var mı?"}

    Q4 -->|"Evet"| ACCEPT["📝 acceptEdits\nDosya düzenlemeleri otomatik"]
    Q4 -->|"Hayır"| DEFAULT["⚖️ default\nHer şeyi sor"]
